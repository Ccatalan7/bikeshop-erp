-- Find all data created by tenant 46e169a4-ba62-4f86-92cd-778ece1b0afa in the last 2 hours
-- Run this in Supabase SQL Editor
-- NOTE: Times are in UTC. Adjust interval for timezone differences (Chile is UTC-3, Seattle is UTC-8)
-- Change '2 hours' -> '8 hours' to account for timezone + actual time window
