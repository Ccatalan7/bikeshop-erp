...
**Production progress:** The shared operation/checkpoint kernel covers invoices, payments, POS/Quick Sale, structured adjustments, bulk parent/child rows, imports, conversions, online cancellation, and manual online transfer confirmation. Workshop ownership is certified in shadow mode. Checkout/provider events are replay-safe, manual transfer confirmation is row-locked and idempotent with a proven two-session race, and unpaid cancellation preserves linked reversal evidence. Existing anomalies were not repaired. Optional future transfers/reservations, purchase-receipt enforcement, historical review, and observation remain open.
