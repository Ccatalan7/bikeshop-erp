...
class ProductCategoryResolver {
  ...
  static const Map<String, List<String>> canonicalLeavesByFamily =
    ...
    'seatpost': ['postes de asiento', 'poste de asiento', 'tija', 'tijas'],
    'seatpost_shim': [
    ...
    'seat_clamp': [
      ...
      'abrazaderas del poste de asiento',
      'collarin',
      'collarines',
      'abrazadera de tija',
    ],
    ...
    'derailleur_hanger_extender': [
      'extensores de postiza',
      'extensor de postiza',
      'extensores de pata de cambio',
    ...
    'fender': ['tapabarros', 'barrofangos', 'guardabarros'],
