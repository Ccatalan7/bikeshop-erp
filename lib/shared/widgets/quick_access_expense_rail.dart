  ...
  void _applyOcrData(ParsedInvoice parsedInvoice) {
    ...
    setState(() {
      ...
      if (parsedInvoice.invoiceNumber != null &&
        ...
        _referenceController.text = parsedInvoice.invoiceNumber!.trim();
      }
      ...
      if (_descriptionController.text.trim().isEmpty) {
        final name = supplier?.name ?? parsedInvoice.supplierName;
        _setDescriptionText(name == null ? 'Gasto escaneado' : 'Gasto $name');
      }
    });
