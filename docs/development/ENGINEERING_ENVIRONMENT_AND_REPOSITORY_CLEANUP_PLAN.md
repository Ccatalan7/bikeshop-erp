...
| 6 — Repository cleanup | In progress | Generated waste and screenshots were removed; root SQL is fully classified; dated handoffs plus completed fix/migration summaries are indexed under `docs/archive/YYYY-MM`. Script, living-doc authority, and Dart provenance batches remain. |
