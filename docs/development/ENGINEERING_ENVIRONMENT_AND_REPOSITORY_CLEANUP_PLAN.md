...
| 6 — Repository cleanup | In progress | Generated waste and screenshots were removed; root SQL is fully classified into diagnostics, quarantined recovery, and archive evidence; dated handoffs are now indexed under `docs/archive/YYYY-MM`. Script, undated-doc, and Dart provenance batches remain. |
