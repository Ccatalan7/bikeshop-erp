-- 2026-09-07 pre-2400 live preimage. Keep the 2026-09-06 legacy assertion unchanged.
-- KMC fact provenance/updated_at and product revision differ; technical values remain equal in the 1653-product-fact scope.
...
) baseline) select 1/case when baseline=$baseline${"products":1665,"facts_md5":"820a0b74b14f6ca9fff76b8576a088a7","readings_md5":"cf177c960938240251a88277890ca220","receipts_md5":"d751713988987e9331980363e24189ce","templates_md5":"0dcae696f4793a0c9314aa2546b08be7","fact_options_md5":"ce5b47bccf0a878598012a490f5378d0","category_mappings_md5":"708e71554a15bac93eef57783a82cce3","product_technical_identity_md5":"d321ab6f91e9d88b94e14bc3d7a563ed"}$baseline$::jsonb then 1 else 0 end preserved_technical_data_assertion from current_state;
