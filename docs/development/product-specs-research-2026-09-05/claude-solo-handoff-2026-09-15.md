...
**Quedan 27.** Rayos se publicó después (`20260916040000`, 58 productos): **quedan 26.** El molde para los siguientes es `scripts/inventory/compile_tire_tube_successors.py`:
