...
- **Sinónimos de lectura: no hacen falta.** *(Corregido el 2026-09-17: sí hacían falta. La
  cuenta de arriba miraba un solo campo de una familia; al medir campo por campo en todo el
  catálogo, el vocabulario de tienda que la etiqueta no reconoce —QR, c/bloqueo, (CL), FreeWheel,
  DER., d/pared, 1-1/8, apernar, 8v, 1/4, prostático— dejaba 676 fichas sin un solo dato. Ver
  el bloque fill-018 más arriba.)* Tras las dos pasadas de rótulos y fill-002c, sólo 3
...
- **fill-021: 11 cadenas KMC sin stock investigadas en kmcchain.eu / kmcchain.com / kmcchain.us y aplicadas (2026-09-17).** Paso, ancho externo (pin length), velocidades, tipo de transmisión, peso por 110 eslabones, conector incluido y sistemas declarados; Art.nr. sólo con color literal o listado de una sola variante. Revisión par en dos rondas: el par detectó filas que citaban la página de modelo sin el valor y las variantes «Long» que rompen «común a todas» → cuatro v2. 6 al taller (HV410/HV408 sin página, K710, «7 velocidades»). Registro en `fill-021-record-2026-09-17.md`.
- **fill-022: cierre de la pasada por marcas sin stock (2026-09-17).** Weinmann U28 ×2 y ZAC19 (ERD, freno, ojetillo desde weinmanntek.com), SunRace CSM400 8BU (lockring, estriado HG M), VP-BC73 de 73 mm (rosca de copas, evidencia de fill-017). Sondeadas sin ficha: Weinmann TM19/COBRA/U32, SunRace M680/MFM300/M10, Suntour XCM/XCT, Novatec (tienda en mantenimiento), Formula, Neco, Zoom. Hallazgo de contrato: `rim_bead_profile` bloquea BSD e interior en casi todas las llantas. Registro en `fill-022-record-2026-09-17.md`.
- **Medición al cierre de la pasada OEM sin stock (2026-09-17).** Cuatro lotes (fill-019 a fill-022): 110 fichas aplicadas con revisión par y recibo. Campos del contrato con dato: 23,2 % → 25,3 % (5 404 → 5 888 de 23 266 en la exportación de bindings); hechos investigados 1 990 → 2 478; fichas sin ningún dato 532 → 504. Por familia (promedio de campos llenos por ficha): cassette 3,19 → 4,66 de 6; cadena 1,31 → 2,71 de 8; biela 1,68 → 2,84 de 11; neumático 2,42 → 2,96 de 7; rotor 1,56 → 2,22 de 8; mazas sin cambio (3,60 de 19: Novatec/Formula/Blooke sin ficha oficial reachable).
- **fill-020: 39 neumáticos de marca sin stock investigados en los sitios oficiales y aplicados (2026-09-17).** Maxxis 18 (maxxis.com/us y /ca más la tienda oficial shop.maxxis.com, única fuente de las variantes de alambre), Arisun 14, Chaoyang 4, Kenda 1, CST 2: ETRTO, TPI, presión declarada, peso, talón y uso sólo cuando la ficha fija la pieza o el valor es común a todas las filas de la medida. Revisión par 39/39 en dos rondas: el par detectó que el archivador de maxxis.com dejaba vacías las celdas de páginas con encabezados distintos; corregido y dos v2. 132 claves cambiadas con recibo. 15 al taller (Kenda ×10 sin ficha oficial, Arisun Mount Buckley y Mount Cook, Duro ×2, Continental Explorer). Registro en `fill-020-record-2026-09-17.md`.
- **fill-019: 55 fichas Shimano sin stock investigadas en productinfo y aplicadas (2026-09-17).** Primer bloque OEM de lo que no tiene stock: cassettes 15, cambios 13, bielas 7, mandos 6, rotores 5, cadenas 5, piñones 3, V-brake 1. Revisión par 55/55 (una v2: FC-A070, caja de 70 mm como rosca italiana en fila «Otro»), 292 claves cambiadas con recibo, 53 modelos fijados. 12 Shimano sin ficha o sin código van al taller. Registro en `fill-019-record-2026-09-17.md`.
- **fill-018: segunda pasada de nombres con vocabulario de tienda, todo el catálogo (2026-09-17).** Tres migraciones: términos de lectura por opción y por booleano (`reading_terms`, `reading_terms_false`), lector que puntúa el término como la etiqueta entera y, entre términos, la frase más larga; 70 familias con reglas (antes 27) y el orden que exige la guardia. Ensayo con rollback 1 705 / 1 705 aceptadas, commit 1 705: **815 hechos nuevos en 576 productos**. Medido por campos del contrato: 1 887 → 2 702 de 11 633 (16,2 % → 23,2 %); fichas sin ningún dato 676 → 266; mazas 2,36 → 3,60 de 19 campos por ficha. Lo que el nombre no da (bridas, ERD, anchos, ejes incluidos) sigue siendo investigación OEM, ahora también para lo que no tiene stock. Recibos y tabla por familia en `fill-018-name-pass2-record-2026-09-17.md`.
- **Medición honesta al cierre de la jornada de lotes (2026-09-16, `scratchpad/needs-research.sql`, bindings resueltos, tenant Viñabike).** 1551 fichas activas: 513 con dato investigado (452 al arrancar), 366 sólo lectura de nombre (395), 672 sin nada (704). En stock: 506, 166 investigadas (105 al arrancar), 340 pendientes (401): 316 en la lista de taller (fabricante sin ficha o nombre sin modelo), 23 Shimano/otros sin ficha añadidos hoy, 1 bloqueado (Saiguan KD-20, salida humana). Aplicadas hoy con revisión par: 23 fichas en cuatro lotes (fill-014 a fill-017); acumulado con recibo: 67 aplicaciones, 322 hechos.
