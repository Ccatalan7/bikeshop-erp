...
select ok((select contract_complete from public.professional_correction_trace_contract_view where operation_id=(select operation_id from public.sales_customer_refunds where id=(select id from settlement_ids where name='sales_refund'))),'customer refund has the full ordered trace contract');
...
select ok((select contract_complete from public.professional_correction_trace_contract_view where operation_id=(select operation_id from public.purchase_supplier_refunds where id=(select id from settlement_ids where name='purchase_refund'))),'supplier refund has the full ordered trace contract');
...
select ok((select contract_complete from public.professional_correction_trace_contract_view where operation_id=(select void_operation_id from public.sales_customer_refunds where id=(select id from settlement_ids where name='sales_refund'))),'customer refund void has the full ordered trace contract');
...
select ok((select contract_complete from public.professional_correction_trace_contract_view where operation_id=(select void_operation_id from public.purchase_supplier_refunds where id=(select id from settlement_ids where name='purchase_refund'))),'supplier refund void has the full ordered trace contract');
