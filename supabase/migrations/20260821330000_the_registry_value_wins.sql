-- El modelo manda «BSA» donde la ficha guarda «BSA / Caja inglesa 34,8 mm
-- (1.37") x 24». Su predicado ganaba sobre el deducido y filtraba a cero.
-- Medido el 2026-08-21: la búsqueda se ejecutaba —89 llamadas— y devolvía
-- vacío, y el modelo lo reportaba como «fuente no disponible».
--
-- Ahora, sobre un campo que la frase del operador ya nombró, manda el valor
-- leído del registro. El modelo conserva los campos que la frase no menciona.
