-- Las palabras que nombran una rama del catálogo se consumían del texto libre
-- —si no, matan el filtro: ningún rotor se llama «discos»— pero no volvían como
-- filtro. Resultado: «discos de freno de 160» traía 23 productos, la mitad de
-- ellos bielas y cadenas con «160» en el nombre.
