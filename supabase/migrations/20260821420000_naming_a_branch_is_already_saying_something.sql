-- «Cuáles son los 5 motores más caros» devolvía cero teniendo treinta y cuatro.
-- La frase no trae ningún filtro técnico, así que el texto libre se conservaba
-- entero: el buscador acotaba a la rama de motores Y además exigía la palabra
-- «motores» dentro del nombre del producto. Ningún motor se llama «motores».
--
-- Nombrar una rama ya es haber dicho algo: basta para reemplazar el texto por
-- lo que quedó sin traducir.
