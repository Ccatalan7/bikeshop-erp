-- La lista de conciliaciones decía «49 decisiones en borrador» cuando eran
-- 49 análisis de la IA y ninguna decisión del operador (2026-09-19). Cuenta
-- por separado lo decidido sin aplicar y lo que la IA ya leyó.
