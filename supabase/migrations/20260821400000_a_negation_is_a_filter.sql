-- «motores que no traen eje» devolvía cero habiendo cinco. La negación no
-- existía como filtro: `includes_spindle` es booleano y ninguna regla la
-- alcanzaba, porque «eje» no es distintivo entre todos los rótulos.
--
-- Entre los campos booleanos del alcance sí lo es, y con eso basta. Sólo se
-- amarra la negación: afirmar es ambiguo y estrecharía de más.
