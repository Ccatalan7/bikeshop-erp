-- «discos de freno de 160» devolvía cero con siete rotores de 160 en bodega.
-- La causa: `rotor_diameter_mm` es una lista cuyos valores son números, y la
-- inferencia sólo miraba palabras para el vocabulario y campos numéricos para
-- las medidas. El mismo hueco tapaba el rodado de las ruedas y el número de
-- rayos.
