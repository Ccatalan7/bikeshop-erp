-- «Qué motores shimano tengo en stock» devolvía diez o más teniendo uno solo.
-- La palabra «shimano» se consumía por aparecer dentro de un valor del
-- vocabulario —«Shimano HG», de piñones— sin convertirse en ningún filtro, y
-- la marca se perdía sin que nadie lo notara.
--
-- Ahora sólo se consumen las palabras que nombran un campo. Lo que no llegó a
-- ser filtro vuelve al texto libre, donde todavía tiene que existir en algún
-- producto de la rama para sobrevivir.
