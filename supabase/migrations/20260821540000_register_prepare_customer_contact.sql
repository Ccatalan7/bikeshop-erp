-- Cuarto lugar del registro de una herramienta: el allowlist de recibos del
-- servidor. Sin esta fila la corrida muere con un 500 opaco sin llegar a la
-- base (aprendido a la mala el 2026-08-21).
