-- La inferencia costaba 660 ms por consulta barriendo todos los productos para
-- decidir qué palabras sobrantes conservar, incluso cuando no sobraba ninguna.
-- Ahora ese barrido se paga por palabra candidata: si la frase quedó
-- completamente traducida, no se toca la tabla de productos.
