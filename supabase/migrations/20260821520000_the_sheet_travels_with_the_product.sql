-- El asistente podía FILTRAR por ficha pero no LEERLA. Ante «qué mano de rosca
-- tiene la cubeta NAKASAWA» sacaba las medidas del nombre del producto, y
-- cuando el nombre no las traía se iba a buscar el dato a internet —un
-- catálogo en Scribd— teniéndolo en su propia base.
--
-- Ahora cada fila del buscador viaja con su ficha resuelta: rótulo y valor,
-- leídos del registro, acotados a 600 bytes.
